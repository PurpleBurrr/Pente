...
public class ShanHelper {
	...
	public ShanHelper (PenteGameBoard b, int stoneColor){
		myBoard=b;
	...
	public ArrayList<OpponentGroup> getEelGroup4(){
		return groups4;
	}
	
	public ArrayList<OpponentGroup> getEelGroup3(){
		return groups3;
	}
	
	public ArrayList<OpponentGroup> getEelGroup2(){
		return groups2;
	}
	
	public ArrayList<OpponentGroup> getEelGroup1(){
		return groups1;
	}
